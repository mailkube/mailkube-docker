...
`mailkube-docker` follows [Semantic Versioning](https://semver.org/). Security
...
[**"Report a vulnerability"**](https://github.com/mailkube/mailkube-docker/security/advisories/new)
